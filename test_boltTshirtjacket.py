...
class TestBoltTshirtjacket():
  ...
  def test_boltTshirtjacket(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"firstName\"]").send_keys("Halit")
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"lastName\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"lastName\"]").send_keys("Kalaycıoğlu")
    ...
    self.driver.save_screenshot(f"{self.folderPath}/shop bolt Tshirt and jacket.png")
